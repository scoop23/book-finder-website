...
const CarouselACard = forwardRef(({ data }, ref) => {
  ...
  function titleMessageOnHover() {
    ...
    const titleRectangle = rectTitleContainer.current.getBoundingClientRect(); // get the full width of the container to get the middle point.
  ...
  const hoverTitle = () => { // used react portal to position the tooltip on top of all the divs.
    return createPortal(
