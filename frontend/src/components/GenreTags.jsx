    ...
    <div className='flex gap-2'>
      {
        genreArray.length > 0 ? (
          ...
          return (
            <div key={index} className={`${lowerCasedGenre}-tag ${tagStyle} rounded-2xl p-1.5 text-[13px] max-h-[60px] shadow-custom4-first-content text-center max-w-[90px] flex items-center`} style={{
