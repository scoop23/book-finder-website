    ...
    <div className='flex gap-2'>
      {
        genreArray.length > 0 ? (
          ...
          return (
            <div key={index} className={`${lowerCasedGenre}-tag ${tagStyle} rounded-2xl p-2 px-3 text-[13px] max-h-[60px] shadow-custom4-first-content text-center flex items-center`} style={{
