...
const LeftSide = ({topOneBook}) => {
  ...
  return (
      <div style={{boxShadow : "-18px 20px 25px -16px rgba(0,0,0,0.58)"}} className='sidebar p-3 font-inter text-2xl max-w-[700px] max-h-[420px] text-black bg-[#40445a] rounded-2xl'>
