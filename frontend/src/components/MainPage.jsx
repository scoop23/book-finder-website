      ...
      <div className='main-page-wrapper max-w-[1380px] h-[800px] flex justify-center'>
        <div className='main-page flex max-w-[1200px] flex-col gap-8'>
          ...
          <div className='inner-main-page flex flex-row max-w-[1300px] gap-4 items-center'>
            <div className='card shadow-2xl border-zinc-400 min-w-[500px] h-[400px] rounded-2xl border-1 grow bg-primary-blackrock'>
          ...
          <div className='inner-main-page flex flex-row max-w-[1300px] gap-4 items-center'>
            <div className='card shadow-2xl border-zinc-400 border-1  min-w-[600px] h-[300px] rounded-2xl grow bg-primary-blackrock'>
              <Quotes quoteData={state.quoteData}/>
            </div>
            <div className='card shadow-2xl border-zinc-400 border-1  w-[600px] h-[300px] rounded-2xl grow bg-primary-blackrock'>
              <SurpriseMe state={state} dispatch={dispatch}/>
            </div>
            <div className='card shadow-2xl border-zinc-400 border-1  w-[600px] h-[300px] rounded-2xl grow backdrop-blur-2xl'>
            </div>
          </div>
