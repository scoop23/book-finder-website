...
const CarouselBCard = ({ data , CARDWIDTH}) => {
  return (
    <>
      <div className={`font-satoshi carouselB-card w-[${CARDWIDTH}px] h-[220px] bg-zinc-800 rounded-[20px] hover:shadow-custom2 hover:-translate-y-1.5 duration-400 shadow-primary-myblue flex flex-col justify-center`}>
